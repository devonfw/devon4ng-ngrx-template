      import * as froasptempletes from './sampledata-templetes.actions';
      ...
      import {
        ...
        EditData,
        DeleteData,
      } from './sampledata-templetes.actions';
          ...
          describe('AddData', () => {
            it('should create an action', () => {
              ...
              expect({ ...action }).toEqual({
                type: SampleDataActionTypes.ADD_DATA, payload,
              });
            });
          });
      ...
      describe('Edit Data Details', () => {
          describe('EditData', () => {
            it('should create an action', () => {
                  ...
                  expect({ ...action }).toEqual({
                    type: SampleDataActionTypes.EDIT_DATA, payload,
                  });
                });
        });
      ...
      describe('Remove Data Details', () => {
          describe('RemoveData', () => {
            it('should create an action', () => {
                ...
                expect({ ...action }).toEqual({
                  type: SampleDataActionTypes.DELETE_DATA, payload,
                });
              });
        });
